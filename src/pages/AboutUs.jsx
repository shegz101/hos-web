...
const AboutUs = () => {
  return (
    <Box mt="30px" mx={{ base: "15px", md: "100px" }}>
      <Text textAlign="center" fontWeight="bold" mb="15px" fontSize={{ base: "20px", md: "35px" }} color="#000000">
        About Us
      </Text>
      <Flex gap="40px" w="100%" flexDirection={{ base: "column", md: "row" }} justifyContent="space-between">
        ...
        <Flex width={{ base: "100%", md: "calc(55% - 20px)" }} pl={{ base: "0", md: "20px" }} alignItems="center">
          <Box as="img" src={aboutImg} alt="Anout Us Image" w="100%" h="250px" objectFit="cover" />
        </Flex>
      </Flex>
    </Box>
  );
